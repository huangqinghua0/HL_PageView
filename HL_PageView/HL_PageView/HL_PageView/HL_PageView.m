...
- (instancetype)initWithFrame:(CGRect)frame superController:(UIViewController *)superController segmentView:(HL_SegmentView *)segmentView childControllers:(NSArray *)childControllers {
...
- (void)willMoveToSuperview:(UIView *)newSuperview {
    ...
    UIViewController *vc = self.childControllers[self.segmentView.selectedIndex];
